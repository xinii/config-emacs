...
(define-key global-map (kbd "s-e") 'org-roam-ui-export)
...
(define-key global-map (kbd "ESC M-a") 'auto-complete-mode)
(define-key global-map (kbd "ESC M-c") 'c-mode)
(define-key global-map (kbd "ESC M-e") 'emacs-lisp-mode)
(define-key global-map (kbd "ESC M-f") 'fish-mode)
(define-key global-map (kbd "ESC M-h") 'html-mode)
(define-key global-map (kbd "ESC M-i") 'lisp-interaction-mode)
(define-key global-map (kbd "ESC M-j") 'java-mode)
(define-key global-map (kbd "ESC M-l") 'lisp-mode)
(define-key global-map (kbd "ESC M-m") 'markdown-mode)
(define-key global-map (kbd "ESC M-o") 'org-mode)
(define-key global-map (kbd "ESC M-p") 'python-mode)
(define-key global-map (kbd "ESC M-q") 'sql-mode)
(define-key global-map (kbd "ESC M-r") 'auto-revert-mode)
(define-key global-map (kbd "ESC M-s") 'sh-mode)
(define-key global-map (kbd "ESC M-u") 'org-roam-ui-mode)
(define-key global-map (kbd "ESC M-v") 'global-visual-line-mode)
(define-key global-map (kbd "ESC M-w") 'whitespace-mode)
(define-key global-map (kbd "ESC M-y") 'yatex-mode)
