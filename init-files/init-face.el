...
(set-face-attribute 'default nil :family "Sarasa Fixed J" :height 120) ; Font and window size

;; パラメータ設定
(setq visible-bell 1)
(setq initial-frame-alist (append (list '(top . 500) '(left . 2500) '(width . 300) '(height . 60)) initial-frame-alist)) ; only for personal desktop
