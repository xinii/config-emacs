...
(set-face-background 'region "brightblue") ; 選択範囲の色 color-209 -> orange
(set-face-attribute 'default nil :family "Courier New" :height 180) ; Font and window size

;; パラメータ設定
(setq initial-frame-alist (append (list '(top . 0) '(left . 0) '(width . 115) '(height . 46)) initial-frame-alist))
...
;; (menu-bar-mode 1) ; menu bar: 1 for show, 0 for not show
